...
namespace SuperMarioBros
{
    class Block
    {
        ...
        void StartUp()
        {
            ...
            //if ((Bitmap)ImageLoader.LoadImage(LookUp[Convert.ToInt32(ID)][1] + "0") != null)
            if(ImageLoader.LoadImage(LookUp[Convert.ToInt32(ID)][1] + "0") != null)
            {
                tBrush = new List<TextureBrush>();
                sprite = new List<Bitmap>();
                sprite.Add(new Bitmap((Bitmap)ImageLoader.LoadImage(LookUp[Convert.ToInt32(ID)][1] + "0")));
                ...
                if ((Bitmap)ImageLoader.LoadImage(LookUp[Convert.ToInt32(ID)][12]) != null)
                {
            ...
            if (background == false)
            {
                ...
                if ((Bitmap)ImageLoader.LoadImage(LookUp[Convert.ToInt32(ID)][12]) != null)
                {
                    ...
                    hitSprite.Add(new Bitmap((Bitmap)ImageLoader.LoadImage(LookUp[Convert.ToInt32(ID)][12])));
                ...
                if (animated)
                {
                    ...
                    {
                        sprite.Add(new Bitmap((Bitmap)ImageLoader.LoadImage(LookUp[Convert.ToInt32(ID)][1] + i.ToString())));
                        foreach (Bitmap bi in sprite)
                        {
